...
$text{Example 2.11.1}$. Decider with Decision Functions for $\{123\}$
...
$text{Example 2.11.2}$. Decider with Decision Functions for $\{456\}$
...
$text{Example 2.11.3}$. Fibonacci decider $\{123456\}$
