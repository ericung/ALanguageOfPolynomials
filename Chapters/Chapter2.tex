...
From analysis, the number of times the tape head visits a finishing state is the difference of the previous input plus two. This result allows us to write a program to decide if y is in $2x^2$.
...
Current passes records the number of times path traveled hits a finishing state.
