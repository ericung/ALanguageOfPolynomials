...
There are two matrices that form from analysis of the parity of the input and output. It can be concluded that there are three states for each matrix giving a total of six different states.

\section{Assembling Deciders of Fibonacci}
