...
Representing a multivariable monomial of different degrees is a similar. There are many representations of them, however, we'll choose the simplest and have them separate as seen in figure 1.6. Multivariable monomials are a set of individual one variable monomials running simultaneously.
