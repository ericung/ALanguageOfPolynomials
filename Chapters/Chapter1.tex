...
$\textbf{Theorem}$. A monomial decider represented as, $A_n$, can be mapped into a set consisting of the union of the base layer or $A_1 = \bigcup E_1$.
...
$\textbf{Theorem}$. A monomial decider has the property of being compact.
