...
$Decider<cxyz^3n> \equiv cxyz^{3n} = Decider<cx^n> \times Decider<cy^n> \times Decider<cz^n>$ 

where c is some constant

$\\ $

$Decider<cx^{n+m+l}> \times  Decider<cy^m> \times  Decider<cz^l> = cx^n \times  y^m \times z^l$ 
